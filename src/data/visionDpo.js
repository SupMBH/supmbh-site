...
export const visionDpoIntro = `En ${Y}, le DPO n'est plus un contrôleur documentaire. C'est un pilote stratégique à la croisée du droit, de la technique et du business. La convergence du RGPD, de NIS2 et de l'AI Act transforme le poste en profondeur — et exige un profil capable de naviguer dans ces trois dimensions simultanément. Voici ma lecture des enjeux et ma manière d'y répondre.`;

export const visionDpoBlocks = [
  {
    id: 'convergence',
    title: 'La fin des silos : RGPD × NIS2 × AI Act',
    position: `Traiter ces trois textes séparément est une erreur coûteuse. En ${Y}, une faille de sécurité est presque toujours une violation de données personnelles. Un système d'IA qui traite des données personnelles déclenche des obligations RGPD, AI Act et potentiellement NIS2 en parallèle. Le DPO doit porter une vision unifiée de la conformité — pas trois projets en silos.`,
    approach: `Mon double socle juridique et technique me permet de piloter un référentiel de conformité transversal : un seul registre des risques, une DPIA qui intègre nativement les exigences IA et cyber, une chaîne d'alerte unique vers la CNIL et l'ANSSI. Moins de redondance, plus de cohérence, des coûts maîtrisés.`,
    icon: '⚖️',
  },
  {
    id: 'ia',
    title: 'IA en entreprise : encadrer sans freiner',
    position: `L'AI Act classe les systèmes par niveau de risque et impose transparence, traçabilité et supervision humaine. Mais le vrai défi opérationnel, c'est la Shadow AI : les équipes utilisent déjà ChatGPT, Copilot ou des outils internes sans que la DSI ou le DPO ne le sachent. Interdire ne fonctionne pas. Encadrer, cartographier et former, oui.`,
  ...
  {
    id: 'dpo-rssi',
    title: 'Le tandem DPO–RSSI : une obligation, pas une option',
    position: `NIS2 impose des audits de sécurité stricts et des notifications d'incidents en 24h. Le RGPD exige une notification à la CNIL en 72h. En cas de cyberattaque, deux horloges tournent en parallèle. Si le DPO et le RSSI ne parlent pas le même langage ou ne partagent pas les mêmes outils, l'organisation perd un temps critique — et s'expose à des sanctions des deux côtés.`,
    approach: `Avoir un profil technique (Bac+4 développement, réseaux, Linux) en plus du socle juridique me permet de dialoguer directement avec les équipes sécurité sans interprète. Je peux participer à l'analyse d'un incident, comprendre un log, évaluer une vulnérabilité — et qualifier simultanément l'impact RGPD. C'est ce binôme DPO-RSSI intégré dans un même profil qui fait la différence.`,
    icon: '🔗',
  },
  {
    id: 'sanctions',
